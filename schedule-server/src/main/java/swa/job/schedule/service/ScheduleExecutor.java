...
public class ScheduleExecutor {
    ...
    public void schedule(final String jobName) {
        ...
        executorService.schedule(new Runnable() {
            public void run() {
                ScheduleResponse scheduleResponse = scheduleService.schedule(currentjob.getJobName(), currentjob.getAddress());
                jobMapper.insertJobScheduleHistory(jobName, scheduleResponse.getSuccess());
